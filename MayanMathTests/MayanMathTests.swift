...
class MayanMathTests: XCTestCase {
    ...
    func testmayanSymbols() {
        ...
        XCTAssert(0.mayanSymbols(.flat).first!.first!.isEqual(UIImage(named: "zeroDown", in: Bundle(for: MayanMath.self), with: nil)!))
        XCTAssert(1.mayanSymbols(.flat).first!.first!.isEqual(UIImage(named: "one", in: Bundle(for: MayanMath.self), with: nil)!))
        XCTAssert(2.mayanSymbols(.flat).first!.first!.isEqual(UIImage(named: "two", in: Bundle(for: MayanMath.self), with: nil)!))
        XCTAssert(3.mayanSymbols(.flat).first!.first!.isEqual(UIImage(named: "three", in: Bundle(for: MayanMath.self), with: nil)!))
        XCTAssert(4.mayanSymbols(.flat).first!.first!.isEqual(UIImage(named: "four", in: Bundle(for: MayanMath.self), with: nil)!))
        XCTAssert(5.mayanSymbols(.flat).first!.first!.isEqual(UIImage(named: "five", in: Bundle(for: MayanMath.self), with: nil)!))
        XCTAssert(10.mayanSymbols(.flat).first!.first!.isEqual(UIImage(named: "ten", in: Bundle(for: MayanMath.self), with: nil)!))
        XCTAssert(15.mayanSymbols(.flat).first!.first!.isEqual(UIImage(named: "fifteen", in: Bundle(for: MayanMath.self), with: nil)!))
        XCTAssert(20.mayanSymbols(.flat).first!.first!.isEqual(UIImage(named: "one", in: Bundle(for: MayanMath.self), with: nil)!))
        XCTAssert(20.mayanSymbols(.flat).last!.first!.isEqual(UIImage(named: "zeroDown", in: Bundle(for: MayanMath.self), with: nil)!))
        
        XCTAssert(40.mayanSymbols(.flat).first!.first!.isEqual(UIImage(named: "two", in: Bundle(for: MayanMath.self), with: nil)!))
        XCTAssert(400.mayanSymbols(.flat).first!.first!.isEqual(UIImage(named: "one", in: Bundle(for: MayanMath.self), with: nil)!))
        XCTAssert(800.mayanSymbols(.flat).first!.first!.isEqual(UIImage(named: "two", in: Bundle(for: MayanMath.self), with: nil)!))
        XCTAssert(8000.mayanSymbols(.flat).first!.first!.isEqual(UIImage(named: "one", in: Bundle(for: MayanMath.self), with: nil)!))
        XCTAssert(16000.mayanSymbols(.flat).first!.first!.isEqual(UIImage(named: "two", in: Bundle(for: MayanMath.self), with: nil)!))
