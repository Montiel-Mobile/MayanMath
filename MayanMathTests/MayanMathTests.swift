...
class MayanMathTests: XCTestCase {
    ...
    func testmayanSymbols() {
        ...
        XCTAssert(0.mayanSymbols(.flat).first!.first!.isEqual(UIImage.symbol(.zeroDown, .flat)))
        XCTAssert(1.mayanSymbols(.flat).first!.first!.isEqual(UIImage.symbol(.one, .flat)))
        XCTAssert(2.mayanSymbols(.flat).first!.first!.isEqual(UIImage.symbol(.two, .flat)))
        XCTAssert(3.mayanSymbols(.flat).first!.first!.isEqual(UIImage.symbol(.three, .flat)))
        XCTAssert(4.mayanSymbols(.flat).first!.first!.isEqual(UIImage.symbol(.four, .flat)))
        XCTAssert(5.mayanSymbols(.flat).first!.first!.isEqual(UIImage.symbol(.five, .flat)))
        XCTAssert(10.mayanSymbols(.flat).first!.first!.isEqual(UIImage.symbol(.ten, .flat)))
        XCTAssert(15.mayanSymbols(.flat).first!.first!.isEqual(UIImage.symbol(.fifteen, .flat)))
        XCTAssert(20.mayanSymbols(.flat).first!.first!.isEqual(UIImage.symbol(.one, .flat)))
        XCTAssert(20.mayanSymbols(.flat).last!.first!.isEqual(UIImage.symbol(.zeroDown, .flat)))
        
        XCTAssert(40.mayanSymbols(.flat).first!.first!.isEqual(UIImage.symbol(.two, .flat)))
        XCTAssert(400.mayanSymbols(.flat).first!.first!.isEqual(UIImage.symbol(.one, .flat)))
        XCTAssert(800.mayanSymbols(.flat).first!.first!.isEqual(UIImage.symbol(.two, .flat)))
        XCTAssert(8000.mayanSymbols(.flat).first!.first!.isEqual(UIImage.symbol(.one, .flat)))
        XCTAssert(16000.mayanSymbols(.flat).first!.first!.isEqual(UIImage.symbol(.two, .flat)))
